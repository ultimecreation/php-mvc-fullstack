...
<div class="form-card">
    ...
    <form action="" method="POST" enctype="multipart/form-data">
        <input type="hidden" name="csrf_token" value="<?php echo setCsrfToken('http://localhost/php-mvc-fullstack/admin/nouvelle-prestation'); ?>">
        <input type="hidden" name="referer" value="<?php echo linkUrl('/admin/nouvelle-prestation') ?>">
        <div>
